...
namespace Serial
{
    SerialUtil::SerialUtil() : m_dwErrors(0)
        , m_Status()
        , m_bConnected(FALSE)
        , m_hSerial(NULL)
    {
    ...
    SerialUtil::SerialUtil(LPCWSTR lpPortName) : SerialUtil()
    {
    ...
    bool SerialUtil::Init(LPCWSTR lpPortName)
    {
    ...
    int SerialUtil::ReadData(BYTE* lpBuffer, UINT nBufSize)
    {
    ...
    bool SerialUtil::WriteData(BYTE* lpBuffer, UINT nWriteSize)
    {
        DWORD bytesSend;
